...
# PYTHONPATH=. python scripts/txt2img.py --ckpt pretrained/v2-1_512-ema-pruned.ckpt --config configs/stable-diffusion/v2-inference.yaml --device cuda --outdir gen_mrte_refill --n_iter 1 --n_samples 8 --repeat 1 --from-file ../voc_mrte_prompts_refill.txt --ddim_eta 0.5 --n_rows 0 --seed 99
