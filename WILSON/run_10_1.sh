...
if [ $1 = disjoint ] || [ $1 = both ]; then
  ...
  pretr=${path}Incr_5.pth
  exp --name Incr --step 6 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs}
  pretr=${path}Incr_6.pth
  exp --name Incr --step 7 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs}
  pretr=${path}Incr_7.pth
  exp --name Incr --step 8 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs}
  pretr=${path}Incr_8.pth
  exp --name Incr --step 9 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs}
  pretr=${path}Incr_9.pth
  exp --name Incr --step 10 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs}
  pretr=${path}Base_0.pth
  ...
  pretr=${path}Incr_OD_Inp_5.pth
  exp --name Incr_OD_Inp --step 6 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs} --inpainting_old_od
  pretr=${path}Incr_OD_Inp_6.pth
  exp --name Incr_OD_Inp --step 7 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs} --inpainting_old_od
  pretr=${path}Incr_OD_Inp_7.pth
  exp --name Incr_OD_Inp --step 8 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs} --inpainting_old_od
  pretr=${path}Incr_OD_Inp_8.pth
  exp --name Incr_OD_Inp --step 9 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs} --inpainting_old_od
  pretr=${path}Incr_OD_Inp_9.pth
  exp --name Incr_OD_Inp --step 10 --weakly ${dataset_pars} --alpha 0.5 --lr ${lr} --step_ckpt $pretr --loss_de 1 --lr_policy warmup --affinity --epochs ${epochs} --inpainting_old_od
